...
public class MainActivity extends BaseActivity {
    ...
    private void initData() {
        ...
        data1.setId("2059014263");
        data1.setArtist("呱呱华");
        data1.setPicUrl("http://p2.music.126.net/KyrjsR57z1IjYOhAEy1xFg==/109951168241576911.jpg?param=130y130");
        data1.setName("晴天+搁浅+花海");
        songs.add(data1);
    }
    ...
    private void viewConfig() {
        ...
        manager.setPlayStateListener(new MediaPlayerManager.PlayStateListener() {
            ...
            public void onError() {
                //出错
                Toast.makeText(MainActivity.this, "VIP歌曲无法播放", Toast.LENGTH_SHORT).show();
            }
